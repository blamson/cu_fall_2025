...
# Create an nxn matrix for every possible value
# This makes setting up constraints a lot simpler.
# Think of this as a one-hot encoding. 
# Similar to an RGB grid for images, but binary instead.
