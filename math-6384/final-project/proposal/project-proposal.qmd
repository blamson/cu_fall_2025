...
ggplot(n_by_year, aes(x=year, y=n)) +
    ...
    # scale_x_discrete(limits=c("2000","2024")) +
    labs(
        title = "Number of Observations by Year - Full Maryland Dataset",
        x = "",
        y = "Frequency"
    )
```
...
One occurrence ID per row...
One gbifID per row...

These seem to be equivalent. Drop occurrence ID. 
