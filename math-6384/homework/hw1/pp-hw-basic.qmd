...
a) Estimate and create a contour plot of the intensity function (use Scott’s rule for the bandwidth in each direction).  Do the observed data appear to be compatible with CSR?
