...
Estimate and create a contour plot of the intensity function (use Scott’s rule for the bandwidth in each direction).  Comment on the plot in relation to potential departures from CSR.
